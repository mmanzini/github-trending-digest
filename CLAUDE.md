...
1. Read corpus/_master-index.md first to find the right topic
...
- Gaps in coverage
- corpus/README.md out of sync with _master-index.md (missing or extra topics, stale descriptions)
